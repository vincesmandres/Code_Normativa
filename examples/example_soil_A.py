# Example script for generating seismic spectrum for soil type A
...
# Set fixed parameters for soil type A
tipo_suelo = 'A'  # Soil type A
...
ax.set_title('Seismic Design Spectrum NEC - Soil Type A')
