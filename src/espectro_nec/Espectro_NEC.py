...
try:
    ...
    pass  # Manejaremos el error más tarde cuando se intente usar
...
class EspectroSismicoApp:
    ...
    def crear_interfaz(self):
        ...
        ttk.Button(botones_frame, text="Generar Reporte PDF", command=self.generar_reporte_pdf).grid(column=3, row=0, padx=5)
        # En la función crear_interfaz, añadir este botón junto a los otros   
    ...
    def generar_espectro(self):
        try:
            ...
            # Generar el espectro
            T = np.linspace(0, 6, 1000)  # Rango de periodos de 0 a 5 segundos
    ...
    def generar_reporte_pdf(self):
        ...
        try:
            ...
            # Guardar la figura actual en un buffer
            buf = io.BytesIO()
